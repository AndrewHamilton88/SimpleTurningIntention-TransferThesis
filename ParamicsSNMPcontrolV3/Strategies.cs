...
namespace ParamincsSNMPcontrol
{
    ...
    public class BasicStrategy : Strategies
    {
        ...
        public override void ProcessJunction(JunctionAgent JA, int[] PreviousStage)
        {
            ...
            //WinningStage = AS.WithinXPercentStage(AllPossibleStages, JA.AllPhases, LastStage, 30.0);   //This is for the within "X" percent bid
            ...
            {
                Bid B = SA.StageBid;
                if (B.Scalar > BidHolder)               //AH Needs to change this for choosing the best stage
                {
                    WinningStage = Stage;
                    BidHolder = B.Scalar;
                }
    ...
    public class HighBidTurn : BasicStrategy  //- - - - - > Need to figure this out, have just copied HighBid! AH 15/03/13
    {
